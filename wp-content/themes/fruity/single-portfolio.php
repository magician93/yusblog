...
<?php if ($theme->display('icon_rss')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_rss'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_rss'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
<?php if ($theme->display('icon_twitter')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_twitter'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_twitter'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
<?php if ($theme->display('icon_facebook')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_facebook'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_facebook'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
<?php if ($theme->display('icon_digg')) { ?><li class="right"><a target="_blank" href="<?php $rvd_fruity_theme->option('url_digg'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_digg'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>

<?php if ($theme->display('icon_google')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_google'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_google'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
<?php if ($theme->display('icon_reddit')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_reddit'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_reddit'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>

<?php if ($theme->display('icon_flickr')) { ?><li><a target="_blank" href="<?php $rvd_fruity_theme->option('url_flickr'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_flickr'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
<?php if ($theme->display('icon_vimeo')) { ?><li class="right"><a target="_blank" href="<?php $rvd_fruity_theme->option('url_vimeo'); ?>"><img src="<?php $rvd_fruity_theme->option('icon_vimeo'); ?>" alt="" title="" class="rounded-half"/></a></li><?php } ?>
