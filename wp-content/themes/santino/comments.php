...
<div id="comments" class="comments-area">
    ...
    <?php if( have_comments() ) : ?>
        <div class="page-title" style="margin:30px 0px 43px;">
            <h1>
                <?php
                printf( _nx( '1 comment', '%1$s comments', get_comments_number(), 'comments title', BW_THEME ), number_format_i18n( get_comments_number() ) );
                ?>
            </h1>
    ...
    $comment_args = array(
        ...
        'title_reply' => '<div class="page-title" style="margin: 30px 0px 43px;"><h3>' . __('Post a new comment', BW_THEME) . '</h3><span class="separator"></span></div>',
