...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'bw--mp bw--isotope' ); ?>>
    ...
    <div class="isotope-bg">
        <div class="isotope-holder" style="padding-bottom:<?php echo $bw_es; ?>px">
            <div class="isotope metro" data-space="<?php echo $bw_es; ?>" style="padding:<?php echo $bw_es; ?>px 0 <?php echo $bw_es; ?>px <?php echo $bw_es; ?>px">

                <?php if( $enable_gallery_cover and ! empty( $gallery_cover_image['url'] ) ): ?>

                    <div class="isotope-item item-h2 item-w2 gallery-cover" style="margin-bottom:<?php echo $bw_es; ?>px;">
                ...
                <?php foreach( Bw::gallerize_by_id( Bw::get_meta( 'gallery' ), 'thumb_424x500_true' ) as $image ): ?>

                    <?php
                    $metro_w = Bw::get_meta( 'metro_width', $image['id'] );
                    $metro_h = Bw::get_meta( 'metro_height', $image['id'] );
                    $thumb = ( $metro_w > 1 or $metro_h > 1) ? 'thumb_920x732' : 'thumb';
                    ?>

                    <div class="isotope-item item-w<?php echo $metro_w; ?> item-h<?php echo $metro_h; ?>" style="margin-bottom:<?php echo $bw_es; ?>px;">
