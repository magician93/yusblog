...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'bw--mp bw--isotope ' ); ?>>
    ...
    <div class="isotope-bg">
        <div class="isotope-holder" style="padding-bottom:<?php echo $bw_es; ?>px">
            <div class="isotope" data-space="<?php echo $bw_es; ?>" style="padding:<?php echo $bw_es; ?>px 0 <?php echo $bw_es; ?>px <?php echo $bw_es; ?>px">
                ...
                <?php foreach( Bw::gallerize_by_id( Bw::get_meta( 'gallery' ), 'thumb_480x760_true' ) as $image ): ?>
