...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'bw--mp bw--isotope ' ); ?>>
    ...
    <div class="isotope-bg">
        <div class="isotope-holder" style="padding-bottom:<?php echo $bw_es; ?>px">
            <div class="isotope isotope-mixed" data-space="<?php echo $bw_es; ?>" style="padding:<?php echo $bw_es; ?>px 0 <?php echo $bw_es; ?>px <?php echo $bw_es; ?>px">

                <?php if( $enable_gallery_cover and ! empty( $gallery_cover_image['url'] ) ): ?>

                    <div class="isotope-item item-h3 item-w1 gallery-cover" style="margin-bottom:<?php echo $bw_es; ?>px;">
                ...
                <?php foreach( Bw::gallerize_by_id( Bw::get_meta( 'gallery' ), 'thumb_424x500' ) as $image ): ?>

                    <?php $video = get_field( 'embed_video', $image['id'] ); ?>
                    <?php $mp_type = !empty( $video ) ? 'iframe' : 'image'; ?>

                    <div class="isotope-item item-h2" style="margin-bottom:<?php echo $bw_es; ?>px;">
                        ...
                        <a class="mp-item mfp-<?php echo $mp_type; ?>" href="<?php echo!empty( $video ) ? $video : $image['original'][0]; ?>" data-title="<?php echo $image['title']; ?>" data-alt="<?php echo $image['info']; ?>">
                            ...
                            <div class="element" style="height:<?php echo $image['thumb'][2]; ?>px;background-image: url('<?php echo $image['thumb'][0] ?>')"></div>
