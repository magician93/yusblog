...
function bw_page_title( $atts ) {
    ...
    return "<div class='page-title {$class}'><h1>{$text}</h1><span class='separator'></span></div>";
}

add_shortcode( 'page_title', 'bw_page_title' );

// white box
function bw_white_box( $atts, $content = null ) {
    ...
    return "<div class='white-box " . $classes . "'>" . do_shortcode( $content ) . "</div>";
}

add_shortcode( 'white_box', 'bw_white_box' );
