...
if ( ! function_exists( 'ot_type_bw_import_data' ) ) {
  ...
  function ot_type_bw_import_data( $args = array() ) {
    ...
    echo '<p class="bw-import-success ' . ( (get_option( 'bw_demo_was_installed', false ) == true) ? 'visible' : '' ) . '"><i class="fa fa-check"></i>' . __( 'Demo content successfully imported', 'option-tree' ) . '</p>';
    echo '</div>';
