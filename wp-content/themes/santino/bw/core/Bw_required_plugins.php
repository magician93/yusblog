	...
	static function required_plugins() {
		...
		self::$plugins = array(
			...
			array(
				...
				'source'   				=> BW_FRAME_PLUGINS . 'contact-form-7.zip', // The plugin source
				'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			...
			array(
				...
				'source'   				=> BW_FRAME_PLUGINS . 'post-types-order.zip', // The plugin source
				'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			...
			# recomended
			array(
				'name'     				=> 'Background Music Player', // The plugin name
				'slug'     				=> 'background-music-player-lite', // The plugin slug (typically the folder name)
				'source'   				=> BW_FRAME_PLUGINS . 'background-music-player-lite.zip', // The plugin source
				'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
				'version' 				=> '1.0.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
				'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
				'external_url' 			=> 'https://wordpress.org/plugins/background-music-player-lite/', // If set, overrides default API URL and points to an external URL
			),
			array(
				'name'     				=> 'Regenerate Thumbnails', // The plugin name
				'slug'     				=> 'regenerate-thumbnails', // The plugin slug (typically the folder name)
				'source'   				=> BW_FRAME_PLUGINS . 'regenerate-thumbnails.zip', // The plugin source
				'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
