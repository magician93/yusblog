	...
	class RWMB_File_Field
	{
		...
		static function wp_ajax_delete_file()
		{
			...
			if ( $ok )
				...
				RW_Meta_Box::ajax_response( __( 'Error: Cannot delete file', 'color-theme-framework' ), 'error' );
		}
		...
		{
			$i18n_title = apply_filters( 'rwmb_file_upload_string', _x( 'Upload Files', 'file upload', 'color-theme-framework' ), $field );
			$i18n_more  = apply_filters( 'rwmb_file_add_string', _x( '+ Add new file', 'file upload', 'color-theme-framework' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_file_delete_string', _x( 'Delete', 'file upload', 'color-theme-framework' ) );
			$i18n_edit   = apply_filters( 'rwmb_file_edit_string', _x( 'Edit', 'file upload', 'color-theme-framework' ) );
			$li = '
			<li>
