...
if ( ! class_exists( 'RWMB_Image_Field' ) )
{
	class RWMB_Image_Field extends RWMB_File_Field
	{
		...
		static function wp_ajax_reorder_images()
		{
			...
			RW_Meta_Box::ajax_response( __( 'Order saved', 'color-theme-framework' ), 'success' );
		}
		...
		{
			$i18n_title = apply_filters( 'rwmb_image_upload_string', _x( 'Upload Images', 'image upload', 'color-theme-framework' ), $field );
			$i18n_more  = apply_filters( 'rwmb_image_add_string', _x( '+ Add new image', 'image upload', 'color-theme-framework' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_image_delete_string', _x( 'Delete', 'image upload', 'color-theme-framework' ) );
			$i18n_edit   = apply_filters( 'rwmb_image_edit_string', _x( 'Edit', 'image upload', 'color-theme-framework' ) );
			$li = '
				<li id="item_%s">
					<img src="%s" />
